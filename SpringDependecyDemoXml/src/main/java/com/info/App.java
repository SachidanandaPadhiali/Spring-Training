...
public class App 
{
    public static void main( String[] args )
    {
		...
		System.out.println("Id :"+e.getId()+"  Name  :"+e.getName()+"  Salary :"+e.getSal()+"Address :"+e.getAdd().display());
		...
		System.out.println("Address of the Employee through constructor based Auto wiring  "+e2.getAdd().display());
